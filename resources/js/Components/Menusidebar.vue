...
<ul class="menu-inner py-1">
  ...
  <li class="menu-item " :class="$route.path == '/store' ? 'active' : ' '" > 
    <router-link to="/store" class="menu-link" >
      ...
      <div class="text-truncate" data-i18n="Dashboards">ສະຕອກສິນຄ້າ</div>
    </router-link>
  </li>
  ...
  <li class="menu-item " :class="$route.path == '/pos' ? 'active' : ''">
    <router-link to="/pos" class="menu-link ">
      ...
      <div class="text-truncate" data-i18n="Dashboards">ຂາຍສິນຄ້າPOS</div>
    </router-link>
  </li>
...
<script>
   ...
   // computed ເເມ່ນ function ເມື່ອຕົວເເປລມີການປ່ຽນເເປງ
        computed:{
