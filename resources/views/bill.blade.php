...
<body style="background-color:white ; font-family:'Phetsarath OT';">
...
<h2 class="mt-4">ໃບບິນຮັບເງີນ</h2>
<div class="d-flex justify-content-end ">
    <span>ໃບບິນເລກທີ: {{ $bill[0]['bill_id'] }} </span>
</div>
